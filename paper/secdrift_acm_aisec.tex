...
The \secdrift{} benchmark, framework, prompts, generated code, SAST findings, per-reviewer human-validation verdicts, and analysis scripts, is provided for review as an anonymized repository: \url{https://anonymous.4open.science/r/SecDrift-0000}. A permanently archived, de-anonymized release will accompany the camera-ready version.
